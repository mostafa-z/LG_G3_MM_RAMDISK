...
case "$1" in
	BusyBox_ver)
		$BB echo "`$BB cat /data/.gabriel/busybox_ver`"
	;;
	...
	LiveCPU_HOTPLUG)
		...
		echo "Default HotPlug: $DEFAULT_HOTPLUG@nAlucard HotPlug: $ALUCARD_HOTPLUG@nMSM HotPlug: $MSM_HOTPLUG@nIntelli HotPlug: $INTELLI_HOTPLUG@nThunder HotPlug: $THUNDER_HOTPLUG"
	;;
